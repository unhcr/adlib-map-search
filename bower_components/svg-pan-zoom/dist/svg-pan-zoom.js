...
module.exports = {
  enable: function(instance) {
    ...
    zoomGroup.setAttribute('transform', 'translate(' + ( -15 ) + ' ' + ( 5 ) + ') scale(0.75)');
...
, _createZoomReset: function(instance){
    ...
    resetPanZoomControl.setAttribute('style', 'visibility: hidden');
...
, _createZoomOut: function(instance){
    ...
    zoomOut.setAttribute('transform', 'translate(30.5 30) scale(0.015)');
